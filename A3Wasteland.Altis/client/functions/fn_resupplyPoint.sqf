...
_pylons = //Array of all possible pylon weapons
  [
	...
	["PylonRack_4Rnd_BombDemine_01_F",		5000]		//Demining Drone Charges
];
...
Switch (true) do
{
	...
	[
		...
		"B_G_Offroad_01_F", "B_G_Offroad_01_armed_F", "B_G_Offroad_01_repair_F", "O_G_Offroad_01_F", "O_G_Offroad_01_armed_F", "O_G_Offroad_01_repair_F", 
		"I_G_Offroad_01_F", "I_G_Offroad_01_armed_F", "I_G_Offroad_01_repair_F", "B_G_Quadbike_01_F", "B_G_Van_01_transport_F", "B_G_Mortar_01_F",
		...
		"C_Offroad_02_unarmed_F", "C_Offroad_01_F", "C_Offroad_01_repair_F", "C_Offroad_01_repair_F", "C_Quadbike_01_F", "C_SUV_01_F", "C_Van_01_transport_F", "C_Van_01_box_F", "C_Truck_02_fuel_F",
	...
	{
		//Non Dynamic vehicles are serviced based on percentage of store price
	...
	//Dynamic Vehicles With 1 pylon
	case ({_vehicle iskindof _x} count ["C_IDAP_UAV_06_antimine_F"] >0):
	{
		...
		_totalprice = (_baseprice + _pylon1price);
