...
if (isServer) then
{
	private _configfile = selectrandom ["Abdera", "ConstructionZone", "GhostHotel", "Kavala", "KoreFactory", "Magos", "MilHill", "Molos", "MOUTVillage", "Oreokastro", "Panagia","Sofia", "Therisa", "Zaros"];
