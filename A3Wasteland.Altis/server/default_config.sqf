...
A3W_timeMultiplierNight = 10;     // Sets the speed of time between 8 PM and 5 AM
...
A3W_mineLifetime = 6;           // Maximum lifetime in hours for saved mines across server restarts (0 = no time limit)
