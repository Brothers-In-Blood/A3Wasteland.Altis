...
//  @file Information: Function called as:  [_aiGroup1, _missionPos, _buildingRadius, _fillEvenly, _putOnRoof] call moveIntoBuildings;
...
private ["_unitIndex","_aiGroup1","_missionPos","_units","_buildingsArray", "_j", "_building", "_randomIndex", "_housePos", "_startAngle", "_i", "_k", "_hitCount", "_fillEvenly", "_putOnRoof", "_isRoof", "_housePos", "_edge", "_checkPos"];

_aiGroup1 = _this select 0;
_missionPos = _this select 1;
_buildingRadius = _this select 2;
_fillEvenly = _this select 3;
_putOnRoof = _this select 4;
_units = units _aiGroup1;
_unitIndex = 0;
