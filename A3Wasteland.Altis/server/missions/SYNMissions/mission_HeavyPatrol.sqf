...
_setupObjects =
{
	...
	_createVehicle = 
	{
		...
		if (_drivers > 0) then
		{
			...
			{
				private _Driver = [_aiGroup, _position, "SYN", "Rifleman"] call createsoldier;
		...
		if (_Commanders > 0) then
		{
			...
			{
				private _Commander = [_aiGroup, _position, "SYN", "Rifleman"] call createsoldier;
				_Commander moveInCommander _vehicle;
			};
		};
		if (_Gunners > 0) then
		{
			private _gunner = [_aiGroup, _position, "SYN", "Rifleman"] call createsoldier;
		...
		if (_Passangers > 0) then
		{
			for "_i" from 1 to _Passangers do
			{
				...
				_soldier = [_aiGroup, _missionPos, "SYN", _soldierType] call createsoldier;
