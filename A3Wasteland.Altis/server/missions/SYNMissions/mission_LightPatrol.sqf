...
_setupObjects =
{
	...
	_missionHintText = format ["A convoy containing at least a <t color='%'>%1</t> is patrolling Altis! Stop the patrol and capture the goods and money!", _vehicleName, SYNMissionColor];
