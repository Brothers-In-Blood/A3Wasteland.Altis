...
_setupObjects =
{
 ...
 _soldier triggerDynamicSimulation true;
	...
	_missionHintText = format ["A <t color='%2'>%1</t> is transporting stolen weapons and cash. Shoot it down and kill the pilot to recover the money and weapons!", _vehicleName, sideMissionColor];
