...
_setupVars =
{
	_missionType = "CSAT helicopter Formation";
...
_setupObjects =
{
	...
	_veh1 = selectrandom ["O_Heli_Attack_02_dynamicLoadout_F","O_Heli_Light_02_dynamicLoadout_F"];
	_veh2 = selectrandom ["O_Heli_Transport_04_F","O_Heli_Transport_04_ammo_F","O_Heli_Transport_04_bench_F","O_Heli_Transport_04_box_F","O_Heli_Transport_04_fuel_F","O_Heli_Light_02_unarmed_F"];
	_veh3 = selectrandom ["O_Heli_Attack_02_dynamicLoadout_F","O_Heli_Light_02_dynamicLoadout_F"];
	...
	createMissionVehicle = 
	{
		...
		if (_drivers > 0) then
		{
			...
			{
				private _Driver = [_aiGroup1, _position] call createCSATRegularCrew;
		...
		if (_Commanders > 0) then
		{
			...
			{
				private _Commander = [_aiGroup1, _position] call createCSATRegularCrew;
				_Commander moveInCommander _vehicle;
			};
		};
		if (_Gunners > 0) then
		{
			private _gunner = [_aiGroup1, _position] call createCSATRegularCrew;
		...
		if (_Passangers > 0) then
		{
			for "_i" from 1 to _Passangers do
			{
				...
				{
					case "Rifleman": {_soldier = [_aiGroup1, _missionPos] call createCSATRegularRifleman};
					case "AT": {_soldier =[_aiGroup1, _missionPos] call createCSATRegularAT};
					case "AA": {_soldier =[_aiGroup1, _missionPos] call createCSATRegularAA};
					case "SAW": {_soldier =[_aiGroup1, _missionPos] call createCSATRegularSAW};
					case "Engineer": {_soldier =[_aiGroup1, _missionPos] call createCSATRegularEngineer};
					case "Medic": {_soldier =[_aiGroup1, _missionPos] call createCSATRegularMedic};
					case "Grenedier": {_soldier =[_aiGroup1, _missionPos] call createCSATRegularGrenedier};
					case "Marksman": {_soldier =[_aiGroup1, _missionPos] call createCSATRegularMarksman};
				};
