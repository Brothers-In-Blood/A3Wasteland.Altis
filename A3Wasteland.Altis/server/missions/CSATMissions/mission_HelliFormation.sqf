...
_setupObjects =
{
	...
	_createVehicle = 
	{
		...
		if (_drivers > 0) then
		{
			...
			{
				private _Driver = [_aiGroup, _position] call createCSATRegularCrew;
		...
		if (_Commanders > 0) then
		{
			...
			{
				private _Commander = [_aiGroup, _position] call createCSATRegularCrew;
				_Commander moveInCommander _vehicle;
			};
		};
		if (_Gunners > 0) then
		{
			private _gunner = [_aiGroup, _position] call createCSATRegularCrew;
		...
		if (_Passangers > 0) then
		{
			for "_i" from 1 to _Passangers do
			{
				...
				{
					case "Rifleman": {_soldier = [_aiGroup, _missionPos] call createCSATRegularRifleman};
					case "AT": {_soldier =[_aiGroup, _missionPos] call createCSATRegularAT};
					case "AA": {_soldier =[_aiGroup, _missionPos] call createCSATRegularAA};
					case "SAW": {_soldier =[_aiGroup, _missionPos] call createCSATRegularSAW};
					case "Engineer": {_soldier =[_aiGroup, _missionPos] call createCSATRegularEngineer};
					case "Medic": {_soldier =[_aiGroup, _missionPos] call createCSATRegularMedic};
					case "Grenedier": {_soldier =[_aiGroup, _missionPos] call createCSATRegularGrenedier};
					case "Marksman": {_soldier =[_aiGroup, _missionPos] call createCSATRegularMarksman};
				};
