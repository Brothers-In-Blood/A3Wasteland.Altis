...
#define MISSION_CTRL_TYPE_NAME "Primary Mission"
#define MISSION_CTRL_FOLDER "PrimaryMisions"
#define MISSION_CTRL_DELAY (["A3W_PrimaryMissionDelay", 120*60] call getPublicVar)
