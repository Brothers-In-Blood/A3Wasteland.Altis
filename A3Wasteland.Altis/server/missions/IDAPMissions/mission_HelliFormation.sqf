...
_setupVars =
{
	_missionType = "IDAP Medium Patrol";
...
_setupObjects =
{
	...
	_veh1 = "C_IDAP_Heli_Transport_02_F";
	_veh2 = "C_IDAP_Heli_Transport_02_F";
	_veh3 = "C_IDAP_Heli_Transport_02_F";
	...
	createMissionVehicle = 
	{
		...
		if (_Commanders > 0) then
		{
			...
			{
				private _Commander = [_aiGroup1, _position, "IDAP", "Rifleman"] call createsoldier;
				_Commander moveInCommander _vehicle;
			};
		};
		if (_Gunners > 0) then
		{
			private _gunner = [_aiGroup1, _position, "IDAP", "Rifleman"] call createsoldier;
