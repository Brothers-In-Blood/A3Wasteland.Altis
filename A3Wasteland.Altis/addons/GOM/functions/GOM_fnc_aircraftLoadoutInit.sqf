...
GOM_fnc_updateDialog =
{
	...
	_killtext = if (_kills isequalto []) then {"Confirmed kills:<br />None"} else
	{
		...
		_index = -1;
		_killText = _kills apply
		{
			_index = _index + 1;_kind = ([_typeNamesS select _index,_typeNamesPL select _index] select (_x > 1));
			if (_x > 0) then
			{
...
GOM_fnc_handleAmmoCost =
{
	private _magtypes =
	[
		//Magazine,									Mass		What it actually is
		//Aircraft Dynamic Pylons
		["PylonMissile_1Rnd_Bomb_03_F",				250],		//LOM-250G GUIDED BOMB CSAT X1
		["PylonMissile_1Rnd_Bomb_04_F",				250],		//GBU-12 GUIDED BOMB NATO X1
		["PylonMissile_1Rnd_Mk82_F",				500],		//MK-82 DUMB BOMB X1
		["PylonMissile_Bomb_GBU12_x1",				250],		//GBU-12 LASER GUIDIED BOMB X1
		["PylonMissile_Bomb_KAB250_x1",				250],		//KAB250 GUIDED BOMB X1
		["PylonMissile_Missile_AA_R73_x1",			175],		//R-73 X1
		["PylonMissile_Missile_AA_R77_x1",			200],		//R-77 X1
		["PylonMissile_Missile_AGM_02_x2",			800],		//MACER AGM X2
		["PylonMissile_Missile_AGM_KH25_x1",		450],		//KH-25 X1
		["PylonMissile_Missile_AMRAAM_D_INT_x1",	350],		//AMRAAM D X1
		["PylonMissile_Missile_BIM9X_x1",			175],		//BIM8X X1
		["PylonRack_12Rnd_PG_missiles",				400],		//DAGR X12
		["PylonRack_12Rnd_missiles",				350],		//DAR ROCKETS X12
		["PylonRack_19Rnd_Rocket_Skyfire",			500],		//SKYFIRE X19
		["PylonRack_1Rnd_AAA_missiles",				300],		//ASRAAM X1
		["PylonRack_1Rnd_GAA_missiles",				400],		//ZYPHER X1
		["PylonRack_1Rnd_LG_scalpel",				250],		//SCALPEL X1
		["PylonRack_1Rnd_Missile_AA_03_F",			175],		//SAHR-3
		["PylonRack_1Rnd_Missile_AA_04_F",			300],		//FALCHION 22 X1
		["PylonRack_1Rnd_Missile_AGM_01_F",			400],		//SHARUR X1
		["PylonRack_1Rnd_Missile_AGM_02_F",			400],		//MACER AGM X1
		["PylonRack_20Rnd_Rocket_03_AP_F",			500],		//TRATNYR AP ROCKETS X20
		["PylonRack_20Rnd_Rocket_03_HE_F",			500],		//TRATNYR HE ROCKETS X20
		["PylonRack_3Rnd_LG_scalpel",				750],		//SCALPEL X3
		["PylonRack_3Rnd_Missile_AGM_02_F",			1200],		//MACER AGM X3
		["PylonRack_4Rnd_BombDemine_01_F",			500],		//Demining Drone Charges
		["PylonRack_4Rnd_LG_scalpel",				1000],		//SCALPEL X4
		["PylonRack_7Rnd_Rocket_04_AP_F",			375],		//SHRIEKER AP ROCKETS X7
		["PylonRack_7Rnd_Rocket_04_HE_F",			375],		//SHRIEKER HE ROCKETS X7
		["PylonRack_Bomb_GBU12_x2",					500],		//GBU-12 LASER GUIDED BOMB X2
		["PylonRack_Missile_AGM_02_x1",				400],		//MACER II AGM X1
		["PylonRack_Missile_AGM_02_x2",				800],		//MACER II X2
		["PylonRack_Missile_AMRAAM_C_x1",			350],		//AMRAAM C X1
		["PylonRack_Missile_AMRAAM_C_x2",			700],		//AMRAAM C X2
		["PylonRack_Missile_AMRAAM_D_x2",			700],		//AMRAAM D X2
		["PylonRack_Missile_BIM9X_x2",				350],		//BIM9X X2
		["PylonWeapon_2000Rnd_65x39_belt",			100],		//6.5mm GATTLING GUN (RIGHT SIDE)
		["PylonWeapon_300Rnd_20mm_shells",			100],		//20mm TWIN CANNON
		//Non Dynamic magazines
		["1000Rnd_20mm_shells",						200],		//Blackfoot cannon ammo
		["1000Rnd_65x39_Belt_Green",				100],		//6.5 coax ammo
		["1000Rnd_65x39_Belt_Yellow",				100],
		["1000Rnd_762x51_Belt_Yellow",				100],
		["1000Rnd_Gatling_30mm_Plane_CAS_01_F", 	1000],		//Wipeout cannon ammo
		["100Rnd_105mm_HEAT_MP",					1000],		//Blackfish 102mm cannon rounds
		["100Rnd_127x99_mag_Tracer_Red",			25],
		["100Rnd_127x99_mag_Tracer_Yellow",			25],
		["12Rnd_125mm_HEAT_T_Green",				150],
		["12Rnd_125mm_HE_T_Green",					150],
		["12Rnd_230mm_rockets",						1200],
		["130Rnd_338_Mag",							10],
		["140Rnd_30mm_MP_shells_Tracer_Green",		220],		//30mm/Kamysh MP rounds
		["140Rnd_30mm_MP_shells_Tracer_Yellow",		220],
		["14Rnd_120mm_HE_shells_Tracer_Yellow",		140],		//Kuma cannon HE rounds
		["160Rnd_40mm_APFSDS_Tracer_Red_shells",	320],		//blackfish 40mm cannon APFSDS rounds
		["16Rnd_120mm_HE_shells_Tracer_Red",		160],
		["1Rnd_GAA_missiles",						50],
		["1Rnd_GAT_missiles",						50],
		["2000Rnd_65x39_Belt_Tracer_Green_Splash",	100],		//Orca minigun ammo
		["2000Rnd_65x39_Belt_Tracer_Red",			100],		//Helicopter Door gunner minigun ammo
		["2000Rnd_65x39_Belt_Tracer_Yellow",		250],
		["2000Rnd_65x39_belt",						100],		//6.5 LMG ammo
		["2000Rnd_762x51_Belt_Green",				250],
		["2000Rnd_762x51_Belt_Yellow",				500],		//Kuma coax ammo
		["200Rnd_127x99_mag_Tracer_Green",			50],
		["200Rnd_127x99_mag_Tracer_Yellow",			50],
		["200Rnd_40mm_G_belt",						220],
		["20Rnd_105mm_HEAT_MP_T_Red",				200],		//Slammer Cannon HEAT rounds
		["240Rnd_40mm_GPR_Tracer_Red_shells",		480],		//Blackfish 40mm cannon GP rounds
		["24Rnd_125mm_APFSDS_T_Green",				300],
		["250Rnd_30mm_APDS_shells_Tracer_Green",	300],		//Kajman/Xian cannon APDS ammo
		["250Rnd_30mm_HE_shells_Tracer_Green",		300],		//Kajman/Xian cannon HE ammo
		["28Rnd_120mm_APFSDS_shells_Tracer_Yellow", 280],		//Kuma cannon AP rounds
		["2Rnd_155mm_Mo_Cluster",					140],
		["2Rnd_155mm_Mo_LG",						40],
		["2Rnd_155mm_Mo_guided",					40],
		["2Rnd_155mm_Mo_guided",					60],
		["2Rnd_GAT_missiles",						160],		//Kamysh/Gorgon AT missiles
		["300Rnd_20mm_shells",						300],		//Buzzard Cannon ammo
		["32Rnd_120mm_APFSDS_shells_Tracer_Red",	320],
		["32Rnd_155mm_Mo_shells",					640],
		["4000Rnd_20mm_Tracer_Red_shells",			4000],		//Blackfish gattling cannon rounds
		["40Rnd_105mm_APFSDS_T_Red",				400],		//Slammer Cannon AP rounds
		["40Rnd_40mm_APFSDS_Tracer_Red_shells",		80],		//Marshal 40mm AP ammo
		["450Rnd_127x108_Ball",						120],
		["4Rnd_LG_Jian",							500],		//Fenhuang missiles
		["4Rnd_Titan_long_missiles",				320],		//Cheetah/Tigris AA missiles
		["5000Rnd_762x51_Belt",						100],		//Pawne minigun ammo
		["5000Rnd_762x51_Yellow_Belt",				100],		//Hellcat minigun ammo
		["500Rnd_127x99_mag_Tracer_Green",			125],
		["500Rnd_127x99_mag_Tracer_Red",			125],		//12.7 MG ammo
		["500Rnd_127x99_mag_Tracer_Yellow",			125],		//Kuma Commander MG ammo
		["500Rnd_65x39_Belt_Tracer_Green_Splash",	50],
		["500Rnd_Cannon_30mm_Plane_CAS_02_F",		500],		//Neophran cannon ammo
		["60Rnd_30mm_APFSDS_shells_Tracer_Green",	120],		//30mm/Kamysh AP rounds
		["60Rnd_30mm_APFSDS_shells_Tracer_Yellow",	120],
		["60Rnd_40mm_GPR_Tracer_Red_shells",		120],		//Marshal 40mm	GP ammo
		["680Rnd_35mm_AA_shells_Tracer_Green",		1000],		//Tigris Autocannon ammo
		["680Rnd_35mm_AA_shells_Tracer_Red",		1000],		//Cheetah autocannon ammo
		["6Rnd_155mm_Mo_AT_mine",					200],
		["6Rnd_155mm_Mo_mine",						180],
		["6Rnd_155mm_Mo_smoke",						100],
		["8Rnd_82mm_Mo_Flare_white",				80],
		["8Rnd_82mm_Mo_Smoke_white",				80],
		["8Rnd_82mm_Mo_shells",						100],
		["96Rnd_40mm_G_belt",						100],
		["96Rnd_40mm_G_belt",						192],		//40mm GP rounds
		["magazine_Missile_rim116_x21",				2100],		//Spartan Turret missiles
		["magazine_Cannon_Phalanx_x1550",			2000],		//Preatorian Ammo
		["magazine_Missile_rim162_x8",				1600],		//Centurion Missiles
		["Pylon_1Rnd_Leaflets_West_F",				1],
		["Pylon_1Rnd_Leaflets_East_F",				1],
		["Pylon_1Rnd_Leaflets_Guer_F",				1],
		["Pylon_1Rnd_Leaflets_Civ_F",				1],
		["Pylon_1Rnd_Leaflets_Custom_01_F",			1],
		["Pylon_1Rnd_Leaflets_Custom_02_F",			1],
		["Pylon_1Rnd_Leaflets_Custom_03_F",			1],
		["Pylon_1Rnd_Leaflets_Custom_04_F",			1],
		["Pylon_1Rnd_Leaflets_Custom_05_F",			1],
		["Pylon_1Rnd_Leaflets_Custom_06_F",			1],
		["Pylon_1Rnd_Leaflets_Custom_07_F",			1],
		["Pylon_1Rnd_Leaflets_Custom_08_F",			1],
		["Pylon_1Rnd_Leaflets_Custom_09_F",			1],
		["Pylon_1Rnd_Leaflets_Custom_10_F",			1],
		//Countermeasures
	...
	//set default ammo weight
	_ammoweight = 100;
	// Find ammo weight based on config array
	{
...
GOM_fnc_setPylonsRefuel =
{
	...
	if (_leaking AND _leakingLevel > 0.9) exitWith 
	{
		systemchat "This aircraft will be heavily leaking fuel when refueling!";systemchat "Repair it first!";playsound "Simulation_Fatal";	_refuelSource setVariable ["GOM_fnc_aircraftLoadoutBusyFuelSource",false,true];
	};
	...
	_refuel = [_veh,_refuelSource,_obj] spawn
	{
		...
		while {fuel _veh < 0.99 AND alive _veh AND !_abort AND !_empty} do
		{
			_fuelLeak = [_veh] call GOM_fuelLeak;
			_fuelleak params ["_leaking","_leakingLevel"];
			if (_leaking AND fuel _veh > (1 - _leakingLevel)) exitWith 
			{
				systemchat format ["This aircraft will leak fuel down to %1%2 unless repaired!",round ( (1 - _leakinglevel) * 100),"%"];systemchat "Stopping Refueling procedure due to fuel leak!";playsound "Simulation_Fatal";	_refuelSource setVariable ["GOM_fnc_aircraftLoadoutBusyFuelSource",false,true];
			};
			...
			if (_timer % 10 isEqualTo 0) then 
			{
				systemchat format ["%1 remaining: %2l, %3s.",_vehDispName,_missingFuel,_timeNeeded];
			};
			_timeout = time + 1;
			waituntil {time > _timeout OR speed _veh > 3 OR speed _refuelSource > 3};
			_timer = _timer + 1;
		};
		if (!_abort AND !_empty AND !_leaking) then 
		{	
...
GOM_fnc_aircraftSetSerialNumber =
{
	...
	if (_numberTextures isequalto []) exitWith
	{
		...
		systemchat "Aircraft does not support tail numbers.";
	...
	{
		_number = _number select [0,3];
		systemchat "Invalid Number, using first 3 digits instead!";
		ctrlSetText [1400,_number select [0,3]];
	};
...
GOM_fnc_aircraftLoadout =
{
	...
	finddisplay 66 displayCtrl 1500 ctrlAddEventHandler ["LBSelChanged",format ["lbclear 1502;lbsetcursel [1502,-1];lbclear 1501;lbsetcursel [1501,-1];[%1] call GOM_fnc_setPylonLoadoutLBPylonsUpdate;;[%1] call GOM_fnc_aircraftLoadoutPaintjob;",_getvar]];//
	...
	findDisplay 66 displayAddEventHandler 
	[
		"KeyDown",
		{
	...
	[
		"KeyUp",
		{
			finddisplay 66 setVariable ["GOM_fnc_keyDown",[]];if (_this select 3) then 
			{
				ctrlEnable [1607,false];ctrlSetText [1607,"CTRL"];
				_veh = call compile lbdata [1500,lbcursel 1500];
				_priorities = _veh getVariable ["GOM_fnc_pylonPriorities",[]];
				if (lbcursel 1501 >= 0) then
				{
