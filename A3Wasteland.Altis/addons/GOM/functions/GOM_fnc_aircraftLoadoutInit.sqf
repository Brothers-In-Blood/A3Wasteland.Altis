...
GOM_fnc_addAircraftLoadout = {
	...
	[_obj,["Service Vehicle",{_this call GOM_fnc_aircraftLoadout}, [], -99, true, true, "", "isPlayer _this AND {_this isequalto vehicle _this} AND {speed _this isequalto 0}"]] call fn_addManagedAction;
	true
