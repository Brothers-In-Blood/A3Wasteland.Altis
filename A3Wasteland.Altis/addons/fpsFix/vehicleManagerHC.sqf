...
A3W_vehicleManagerHC =
{
	...
	{
		if (count crew _vehicle == 0 && {_vehicle getVariable ["fpsFix_simulationCooloff", 0] < diag_tickTime && vectorMagnitude velocity _vehicle < 0.1 && (getPos _vehicle) select 2 < 1}) then
		{
