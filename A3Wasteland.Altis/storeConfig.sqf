...
[
	...
	["SPMG MMG (MTP)",														"MMG_02_camo_F",															1500],
	["SPMG MMG (Black)",													"MMG_02_black_F",															1500],
...
[	
	...
	["Static Titan AT 4Rnd (AAF)",											"I_static_AT_F",															20000],
...
[
	...
	["TWS",																	"optic_tws",																10000,							"item"],// To hide from store list,add "HIDDEN" after "item",like "item","HIDDEN"
...
[
	...
	// ["Basketball Court",																		"Land_BC_Court_F",																			10000],
	...
	// ["Dirt Mound (Low,Long)",																	"Dirthump_4_F",																				500],
	// ["Dirt Mound (Small)",																		"Dirthump_1_F",																				300],
	// ["Dirt Mound,Double Hump (Large)",															"Dirthump_3_F",																				500],
	// ["Dirt Mound,Rampart",																		"Land_Rampart_F",																			300],
	// ["Dirt Mound,Single Hump (Large)",															"Dirthump_2_F",																				500],
	...
	// ["Grave,Concrete w/Standing Cross",															"Land_Grave_V3_F",																			500],
	// ["Grave,Concrete",																			"Land_Grave_V1_F",																			500],
	// ["Grave,Dirt",																				"Land_Grave_dirt_F",																		100],
	// ["Grave,Forest",																			"Land_Grave_forest_F",																	100],
	// ["Grave,Memorial",																			"Land_Grave_memorial_F",																700],
	// ["Grave,Monument",																			"Land_Grave_monument_F",																700],
	// ["Grave,Obelisk",																			"Land_Grave_obelisk_F",																1000],
	// ["Grave,Rocks",																				"Land_Grave_rocks_F",																	100],
	// ["Grave,Unknown Soldier",																	"Land_Grave_soldier_F",																500],
	...
	// ["Oil Tank (Large)",																		"Land_dp_bigTank_F",																		5000],
	// ["Oil Tank (Small)",																		"Land_dp_smallTank_F",																	3000],
	// ["Party Tent",																				"Land_PartyTent_01_F",																	69],
	// ["Payphone (Graffiti)",																		"Land_PhoneBooth_02_malden_F",													500],
	// ["Payphone",																				"Land_PhoneBooth_01_malden_F",													500],
	// ["Pier,Concrete (Huge)",																	"Land_Pier_F",																					50000],
	// ["Pier,Deck",																				"Land_Pier_addon",																			2500],
	// ["Pier,Wooden",																				"Land_Pier_small_F",																		200],
	// ["Pillar,Ancient",																			"Land_AncientPillar_F",																10000],
	["Ramp,Concrete (High)",																	"Land_RampConcreteHigh_F",															500],
	["Ramp,Concrete (Low)",																		"Land_RampConcrete_F",																	500],
	// ["Rock,Boulder (Black)",																	"Land_W_sharpStone_02",																1000],
	// ["Rock,Boulder (Brown)",																	"Land_BluntStone_02",																	1000],
	// ["Rock,Boulder (Grey)",																		"Land_SharpStone_02",																	1000],
	// ["Rock,Boulder (White)",																	"Land_Limestone_01_02_F",															1000],
	// ["Rock,Cluster (Black)",																	"Land_W_sharpRock_apart",															5000],
	// ["Rock,Cluster (Brown)",																	"Land_BluntRock_apart",																5000],
	// ["Rock,Cluster (Grey)",																		"Land_SharpRock_apart",																5000],
	// ["Rock,Cluster (White)",																	"Land_Limestone_01_apart_F",														5000],
	// ["Rock,Flat (Black)",																		"Land_W_sharpRock_monolith",														250000],
	// ["Rock,Flat (Brown)",																		"Land_BluntRock_monolith",															250000],
	// ["Rock,Flat (Grey)",																		"Land_SharpRock_monolith",															250000],
	// ["Rock,Flat (White)",																		"Land_Limestone_01_monolith_F",												250000],
	// ["Rock,Spike (Black)",																		"Land_W_sharpRock_spike",															100000],
	// ["Rock,Spike (Brown)",																		"Land_BluntRock_spike",																100000],
	// ["Rock,Spike (Grey)",																		"Land_SharpRock_spike",																100000],
	// ["Rock,Spike (White)",																		"Land_Limestone_01_spike_F",														100000],
	...
	// ["Statue Pedestal,Bronze",																	"Land_Pedestal_01_F",																	150000],
	// ["Statue Pedestal,Decorative",																"Land_Maroula_base_F",																	100000],
	// ["Statue Pedestal,Sandstone",																"Land_Pedestal_02_F",																	50000],
	// ["Statue,Bronze",																			"Land_Statue_02_F",																		4000000],
	// ["Statue,Bushlurker",																		"Land_Monument_01_F",																	5000000],
	// ["Statue,Decorative",																		"Land_Maroula_F",																			3000000],
	// ["Statue,Sandstone",																		"Land_Statue_01_F",																		2000000],
...
[
	...
	["Military Cargo (Rusty)",																				"Land_Cargo_Tower_V2_F",																7500],
	["Military Cargo (No.1)",																				"Land_Cargo_Tower_V1_No1_F",														15000],
	["Military Cargo (No.2)",																				"Land_Cargo_Tower_V1_No2_F",														15000],
	["Military Cargo (No.3)",																				"Land_Cargo_Tower_V1_No3_F",														15000],
	["Military Cargo (No.4)",																				"Land_Cargo_Tower_V1_No4_F",														15000],
	["Military Cargo (No.5)",																				"Land_Cargo_Tower_V1_No5_F",														15000],
	["Military Cargo (No.6)",																				"Land_Cargo_Tower_V1_No6_F",														15000],
	["Military Cargo (No.7)",																				"Land_Cargo_Tower_V1_No7_F",														15000],
...
[
	...
	["AH-99 Blackfoot",															"B_Heli_Attack_01_dynamicLoadout_F",								500000,						"vehicle"],
	...
	["Mi-290 Taru (Ammo) [DLC]",												"O_Heli_Transport_04_ammo_F",										1250000,					"vehicle"],
	...
	["Mi-48 Kajman",															"O_Heli_Attack_02_dynamicLoadout_F",								300000,						"vehicle"],
	["MQ-12 Falcon",															"B_T_UAV_03_dynamicLoadout_F",										350000,					"vehicle"],
...
[
	...
	["Molon Labe Monument",																 "Land_MolonLabe_F",										 1],
